...
const NoteList = ({ availableTags, notes, onDeleteTag, onUpdateTag }: NoteListProps) => {
  ...
  return (
    <>
      ...
      <EditTagsModal show={editTagsModalIsOpen} handleClose={() =>setEditTagsModalIsOpen(false)} availableTags={availableTags} onDeleteTag={onDeleteTag}onUpdateTag={onUpdateTag}/>
    </>
  );
};
